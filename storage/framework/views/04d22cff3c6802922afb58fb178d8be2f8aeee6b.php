                    ...
                    <form role="form" action="<?php echo e(route('products.update',$product->id)); ?> " method="post" enctype="multipart/form-data">
                      ...
                      <div class="card-body">
                            ...
                            <div class="form-group justify-content-center d-flex">
                                <img src="<?php echo e(asset($product->image)); ?>" alt="avatar" class="fluid rounded-4 " style="width: 150px">
                            </div>
                            <div class="text-center"><label for="avatar" style=""><h4><?php echo e($product->title); ?> </h4></label></div>
...
unset($__errorArgs, $__bag); ?>" 
                                id="exampleInputEmail1" placeholder="Enter title" name="title" value="<?php echo e($product->title); ?> " >
...
unset($__errorArgs, $__bag); ?>" style="width: 100%;" name="category_id">
                                  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option value="<?php echo e($product->category_id); ?>"<?php echo e($product->category_id===$cat->id?"selected":""); ?>>
                                        <?php echo e($cat->name); ?> 
                                    </option>
...
<?php echo $__env->make('layouts.admin_layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel_ecomerce_project\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>