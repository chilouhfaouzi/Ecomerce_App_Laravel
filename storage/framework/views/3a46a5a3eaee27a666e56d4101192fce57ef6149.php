                                    ...
                                    <div class="dash__pad-1">
                                        ...
                                        <ul class="dash__f-list">
                                            ...
                                            <li>
                                                ...
                                                <a href="<?php echo e(Route('edit_account')); ?>">My Profile</a>
                                            </li>
                                        ...
                                        <ul class="dash__w-list">
                                            <li>
                                                <div class="dash__w-wrap">
                                                    ...
                                                    <span
                                                        class="dash__w-text"><?php echo e(getOrdersCount(Auth::user()->id)); ?></span>
                                                ...
                                                <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                                    <div class="dash__pad-3">
                                                        ...
                                                        <div class="dash__link dash__link--secondary u-s-m-b-8">
                                                            ...
                                                            <a href="<?php echo e(Route('edit_account')); ?>">Edit</a>
                                                        </div>
                                            ...
                                            <div class="col-lg-6 u-s-m-b-30">
                                                <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                                    <div class="dash__pad-3">
                                                        ...
                                                        <span class="dash__text"><?php echo e(Auth::user()->lines); ?>

                                                            <?php echo e(Auth::user()->city); ?> - <?php echo e(Auth::user()->zip_code); ?> -
                                                            <?php echo e(Auth::user()->country); ?></span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="dash__table-img-wrap">
                                                                    ...
                                                                    <img class="u-img-fluid" style="height: 100%"
                                                                        src="<?php echo e(getProduct($order->product_id)->image); ?>"
                                                                        alt="">
                                                            ...
                                                            <td>
                                                                <div class="dash__table-total">
                                                                    ...
                                                                    <span
                                                                        class="font-weight-bold"><?php echo e(getPrice(getProduct($order->product_id)->price * $order->qntty)); ?></span>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel_ecomerce_project\resources\views/myaccount.blade.php ENDPATH**/ ?>