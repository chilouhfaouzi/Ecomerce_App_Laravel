...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href="<?php echo e(asset('files/favicon.png')); ?>">
	<!-- Web Font -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="index.html"><img src="<?php echo e(asset('files/logo.png')); ?>" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="<?php echo e(asset('files/logo2.png')); ?>" alt="#"></a>
							</div>
			...
			<div class="container">
				<div class="inner">
					<div class="row">
						...
						<div class="col-lg-6 col-12">
							<div class="right">
								<img src="<?php echo e(asset('files/payments.png')); ?>" alt="#">
							</div>
						</div>
					</div>
				</div>
...
</html><?php /**PATH C:\Users\Fawzi\Desktop\laravel_ecomerce_prj\resources\views/layouts/template.blade.php ENDPATH**/ ?>